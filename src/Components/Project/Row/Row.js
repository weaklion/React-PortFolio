...
const Row = () => (
  <div className="Row">
    <div className="Box">
      ...
      <p><h2 className="name">개발기간 :2018.08.10~ 2018.11.30</h2></p>
     ...
     <div className="Box">
      ...
      <p><h2 className="name">개발기간 :2018.05.26~2018.07.09</h2></p>
    ...
    <div className="Box">
      ...
      <p><h2 className="name">개발기간 :2018.03.10~2018.6.09</h2></p>
